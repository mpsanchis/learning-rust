...
fn main() {
  ...
  println!("\n### About respecting borrow rules");
  do_not_respect_borrow_rules();
...
fn access_and_modify_vector() {
  ...
  p0 = 42;
  println!("After p0=42, the vector remains v: {:?}", v); // [0,1,2]
...
fn do_not_respect_borrow_rules() {
