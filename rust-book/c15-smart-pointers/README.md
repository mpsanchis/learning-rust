...
2. gets a reference to the string with `&`, turning into `&String`
3. takes a slice of the `String` that is equal to all its length, with `[..]`
...
// WIP: deref coercion examples
Note: this works only for single-threaded programs.